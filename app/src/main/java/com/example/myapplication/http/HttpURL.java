...
public class HttpURL {
    public static String LOGIN="http:///hxcihq.com/user/login";
   public  static  String  BAOXIU_INSERT="http:///hxcihq.com/repair/addRepair";
    public static String TIAOWENSELECT="http://hxcihq.com/temp/getTemperatures";
